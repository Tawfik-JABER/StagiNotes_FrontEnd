...
export default function FormatteurLogin() {
  ...
  const loginSubmit = async (e) => {
    ...
    await axios({
      ...
      url: "http://localhost:8000/api/formatteur/login",
      headers: {
      ...
      .then((res) => {
        setLoading(false)
        localStorage.setItem("Token_Form", res.data.token);
        navigate("/formatteur/listNote");
      })
      .catch(() => {
        setLoading(false)
          ...
          <Container component="main" maxWidth="xs">
            ...
            >
              ...
              >
                ...
                >
                  {loading ? <CircularProgress sx={{color:'#eee'}} size={'25px'}/> : 'Se connecter'}
                </Button>
                <Grid container>
                  <Grid item xs>
                    <Link href="/formatteur/resetPassword" variant="body2">
                      Mot de passe oublié?
                    </Link>
                  </Grid>
                </Grid>
