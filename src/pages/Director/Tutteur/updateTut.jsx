...
export default function UpdateTut() {
    ...
    const fetchFormatteur = async() => {
        await axios.get(`http://localhost:8000/api/director/showTutteur/${id}`, {
            headers: {
    ...
    const updateFormatteur = async(e) => {
        e.preventDefault();
        ...
        await axios.post(`http://localhost:8000/api/director/updateTutteur/${id}`,formData, {
            headers: {
                "Accept": "application/json",
                "Authorization": 'Bearer ' + accesToken 
            }})
...
const logout = () => {
    ...
    return (
        ...
        <form action="" onSubmit={updateFormatteur} className="form">
            <div>
